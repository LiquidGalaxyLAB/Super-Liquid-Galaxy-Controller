class GeoReverseCodeResponse {
  List<Results>? results;
  Query? query;

  GeoReverseCodeResponse({this.results, this.query});

  GeoReverseCodeResponse.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'GeoReverseCodeResponse{results: $results, query: $query}';
  }
}
...
class Query {
  ...
  @override
  String toString() {
    return 'Query{lat: $lat, lon: $lon, plusCode: $plusCode}';
  }
}
...
class Bbox {
  ...
  Bbox.fromJson(Map<String, dynamic> json) {
    this.lon1 = json["lon1"]?.toDouble();
    this.lat1 = json["lat1"]?.toDouble();
    this.lon2 = json["lon2"]?.toDouble();
    this.lat2 = json["lat2"]?.toDouble();
  }
...
class Rank {
  ...
  @override
  String toString() {
    return 'Rank{importance: $importance, popularity: $popularity}';
  }
}
