class WikiData {
  ...
  WikiData({this.batchcomplete, this.warnings, this.query});
...
class PageInfo {
  ...
  PageInfo({this.pageid, this.ns, this.title, this.extract});
  ...
  PageInfo.fromJson(Map<String, dynamic> json) {
    ...
    if (json["extract"] is String) this.extract = json["extract"];
  }
  ...
  @override
  String toString() {
    return 'PageInfo(pageid: $pageid, ns: $ns, title: $title, extract: $extract)';
  }
}
